            ...
            {!fileDisplay ? (
              ...
              >
                ...
                <video
                  ...
                  src={fileDisplay}
                />
                <div className="absolute -bottom-12 flex items-center justify-center justify-between z-50 rounded-xl border w-full p-2 border-gray-300">
              ...
              <div className="flex bg-[#F8F8F8] py-4 px-6">
                ...
                <div>
                  ...
                  <div className="text-semibold text-[13px] text-gray-400">
                    You can quickly divide videos into mutiple parts, remove
