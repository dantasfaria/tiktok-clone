...
import { CommentHeaderCompTypes } from "@/app/types"
...
function CommentsHeader({ post, params }: CommentHeaderCompTypes) {
            ...
            <div className="flex items-center justify-between px-8">
                <div className="flex items-center">
                    <Link href={`/profile/${post?.user_id}`}>
                        {post?.profile.image ? (
                            <img className="rounded-full lg:mx-0 mx-auto" width="40" src={post?.profile.image} alt="" />
                        ) : (
                            <div className="2-[40px] h-[40px] bg-gray-200 rounded-full" />
                        )}
                    </Link>
                ...
                {true ? (
                    <div>
                        {isDeleting ? (
                            ...
                            <button disabled={isDeleting} onClick={() => detelePost()}>
