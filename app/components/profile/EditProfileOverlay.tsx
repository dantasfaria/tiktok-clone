  ...
  return (
    <>
        <div
            ...
            className="fixed flex justify-center pt-14 md:pt-[105px] z-50 top-0 left-0 left-0 w-full h-full bg-black bg-opacity-50 overflow-auto"
        >
            <div
                className={`
                ...
                `}
            >
                <div className="absolute flex items-center justify-between w-full p-5 left-0 top-0 border-b border-gray-300">
                            ...
                            >
                                ...
                                <div className="flex items-center justify-center sm:-mt-6">
                                    <label htmlFor="image" className="relative cursor-pointer">
                                        <img className="rounded-full" width="95" src={userImage} alt="" />
